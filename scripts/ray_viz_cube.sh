...
python scripts/visualize_general_cube.py 2>&1 | tee "$SSD/viz_cube.log"

gcloud storage cp eval_results/viz_general_cube.png "$BUCKET/eval/"
gcloud storage cp "$SSD/viz_cube.log" "$BUCKET/eval/viz_cube.log"
echo "VIZ DONE -> $BUCKET/eval/viz_general_cube.png"
