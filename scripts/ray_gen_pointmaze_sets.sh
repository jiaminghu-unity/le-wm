#!/usr/bin/env bash
# RETEST VARIANT of ray_smoke_pointmaze.sh: SEEDS_OVERRIDE env lets us generate fresh
# pre-registered episode sets (e.g. 201-206) for the PointMaze retest. New file.
...
SEEDS="${SEEDS_OVERRIDE:-101 102 103 104 105 106}"
