...
#   usage: ray_automet_fit_phi_nonlinear_any.sh <task> <ckpt_prefix> <ckpt_dir> <tag>
...
python scripts/automet_fit_phi_nonlinear.py "$TASK" --ckpt "$CKPT_DIR/weights_epoch_10.pt" \
